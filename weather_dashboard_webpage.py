...
with main_col:
    ...
    if selected_page == 'Delhi':
        ...
        oahu_map = folium.Map(location=[21.4389, -158.0], zoom_start=11, tiles=None, min_zoom=6, max_bounds=True)
        ...
        ---
        ''')
        bigisland_map = folium.Map(location=[19.6, -155.5], zoom_start=10, tiles=None, min_zoom=6, max_bounds=True)
