...
with main_col:
    ...
    if selected_page == 'Delhi':
        ...
        with col5:
            st.markdown('<div style="background-color:#34c759;padding:10 px 5px;border-radius:12px;text-align:center;color:white;font-weight:bold;font-size:16px;line-height:1.4;">Flood Warning<br><span style="font-size:18px;">No</span></div>', unsafe_allow_html=True)
        with col6:
